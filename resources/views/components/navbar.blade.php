        ...
        <div class="flex h-16 items-center justify-between">
            ...
            -->
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            <a href="/profile"
                                class="{{ request()->is('profile/') ? 'bg-gray-100' : '' }} block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                            <a href="/dashboard"
                                class="{{ request()->is('dashboard/') ? 'bg-gray-100' : '' }} block px-4 py-2 text-sm text-gray-700"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
                <a href="/profile"
                    class="{{ request()->is('/profile') ? 'bg-gray-100' : '' }}block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Your
                    Profile</a>
                <a href="/dashboard"
