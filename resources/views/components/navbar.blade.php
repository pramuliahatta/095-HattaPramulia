<nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <x-nav-link href="/post" :active="request()->is('post')">Your Posts</x-nav-link>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
            ...
            role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <a href="/profile" class="{{ request()->is('profile/') ? 'bg-gray-100' : '' }} block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                <a href="/dashboard" class="{{ request()->is('dashboard/') ? 'bg-gray-100' : '' }} block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Dashboard</a>
    ...
    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/post" class="{{ request()->is('/post') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} block rounded-md px-3 py-2 text-base font-medium">Your Posts</a>
    </div>
    <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <a href="/profile" class="{{ request()->is('/profile') ? 'bg-gray-100' : '' }}block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Your Profile</a>
